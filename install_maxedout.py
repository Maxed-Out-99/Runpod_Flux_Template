#!/usr/bin/env python
"""
FLUX / ComfyUI Automated Installer for RunPod

– Downloads the highest-quality fp8 models by default.
– Skips all hardware detection and user prompts for fast, automated execution.
– Installs required custom nodes and Python packages.
– Resumes partial downloads if interrupted or cancelled.
– Retries failed downloads with exponential backoff.
– Validates file integrity using SHA256 hashes.
– Saves structured logs for debugging.
"""

from __future__ import annotations
import sys, subprocess, time, atexit, signal, requests, hashlib, shutil, os
